...
describe("Recommendations Page ", () => {
  before(() => {
    // Get recommendations movies from TMDB and store in movies variable.
    cy.request(
      `https://api.themoviedb.org/3/movie/${mId}/recommendations?api_key=${Cypress.env("TMDB_KEY")}&language=en-US&page=1`
    )
  ...
  beforeEach(() => {
    cy.visit(`/movies/${mId}/recommendations`)
  });
